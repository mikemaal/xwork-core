 ...
 */
public class DefaultTypeConverterHolder implements TypeConverterHolder, Serializable {
    ...
    * </pre>
    */
   private HashMap<String, TypeConverter> defaultMappings = new HashMap<String, TypeConverter>();

   // non-action (eg. returned value)
   /**
    ...
    * </pre>
    */
   private HashMap<Class, Map<String, Object>> mappings = new HashMap<Class, Map<String, Object>>();

   // action
   /**
    * Unavailable target class conversion mappings, serves as a simple cache.
    */
   private HashSet<Class> noMapping = new HashSet<Class>();
