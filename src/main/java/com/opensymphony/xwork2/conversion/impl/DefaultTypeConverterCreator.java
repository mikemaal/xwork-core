 ...
 */
public class DefaultTypeConverterCreator implements TypeConverterCreator, Serializable {
   ...
   public TypeConverter createTypeConverter(String className) throws Exception {
      ...
      if (obj instanceof TypeConverter) {
         ...
         throw new IllegalArgumentException("Type converter class " + obj.getClass()
               + " doesn't implement com.opensymphony.xwork2.conversion.TypeConverter");
      }
   }
}
