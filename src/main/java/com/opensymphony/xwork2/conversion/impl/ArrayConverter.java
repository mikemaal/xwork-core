...
public class ArrayConverter extends DefaultTypeConverter implements Serializable {
      ...
      if (componentType != null) {
         ...
         if (value.getClass().isArray()) {
            ...
            for (int i = 0; i < length; i++) {
               ...
               Array.set(result, i,
                     converter.convertValue(context, target, member, propertyName, valueItem, componentType));
            }
         } else {
