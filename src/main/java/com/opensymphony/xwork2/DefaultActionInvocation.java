 ...
 * @author tmjee
 * @version $Date: 2013-05-17 14:38:42 +0200 (Fri, 17 May 2013) $ $Id: DefaultActionInvocation.java 1483773 2013-05-17 12:38:42Z lukaszlenart $
 * @see com.opensymphony.xwork2.DefaultActionProxy
 */
public class DefaultActionInvocation implements ActionInvocation, Serializable {
      ...
      if (resultConfig != null) {
         try {
            ...
            if (LOG.isErrorEnabled()) {
               LOG.error("There was an exception while instantiating the result of type #0", e,
                     resultConfig.getClassName());
            }
            throw new XWorkException(e, resultConfig);
         }
      } else if (resultCode != null && !Action.NONE.equals(resultCode) && unknownHandlerManager.hasUnknownHandlers()) {
         return unknownHandlerManager.handleUnknownResult(invocationContext, proxy.getActionName(), proxy.getConfig(),
               resultCode);
      }
      return null;
   }
