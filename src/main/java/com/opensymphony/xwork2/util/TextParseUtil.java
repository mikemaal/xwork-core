 ...
 * @author tm_jee
 *
 * @version $Date: 2013-09-19 08:38:10 +0200 (Thu, 19 Sep 2013) $ $Id: TextParseUtil.java 1524630 2013-09-19 06:38:10Z lukaszlenart $
 */
public class TextParseUtil implements Serializable {
   ...
   public static Object translateVariables(char[] openChars, String expression, final ValueStack stack,
         final Class asType, final ParsedValueEvaluator evaluator, int maxLoopCount) {
