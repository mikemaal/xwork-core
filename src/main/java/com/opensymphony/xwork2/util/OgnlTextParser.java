 ...
 */
public class OgnlTextParser implements TextParser, Serializable {

   public Object evaluate(char[] openChars, String expression, TextParseUtil.ParsedValueEvaluator evaluator,
         int maxLoopCount) {
