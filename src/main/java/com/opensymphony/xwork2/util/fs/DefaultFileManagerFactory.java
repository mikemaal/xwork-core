 ...
 */
public class DefaultFileManagerFactory implements FileManagerFactory, Serializable {
   ...
   public FileManager getFileManager() {
      ...
      if (LOG.isDebugEnabled()) {
         LOG.debug("Using default implementation of FileManager provided under name [system]: #0", systemFileManager
