 ...
 *          $
 */
public class WildcardHelper implements PatternMatcher<int[]>, Serializable {
   ...
   public boolean match(Map<String, String> map, String data, int[] expr) {
      ...
      while (true) {
         ...
         offset = (prevchr == MATCH_FILE) ? indexOfArray(expr, exprpos, charpos, buff, buffpos) : lastIndexOfArray(
               expr, exprpos, charpos, buff, buffpos);
         if (offset < 0) {
            return (false);
         }
