 ...
 */
public class ReloadingClassLoader extends ClassLoader implements Serializable {
      ...
      try {
         if (root != null) {
            ...
            throw new XWorkException(
                  "Unable to start the reloadable class loader, consider setting 'struts.convention.classes.reload' to false");
         }
