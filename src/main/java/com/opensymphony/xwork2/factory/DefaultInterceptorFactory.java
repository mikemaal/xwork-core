 ...
 */
public class DefaultInterceptorFactory implements InterceptorFactory, Serializable {
   ...
   public Interceptor buildInterceptor(InterceptorConfig interceptorConfig, Map<String, String> interceptorRefParams)
      ...
      Map<String, String> params = (thisInterceptorClassParams == null) ? new HashMap<String, String>()
            : new HashMap<String, String>(thisInterceptorClassParams);
      ...
      try {
         ...
         message = "Class [" + interceptorClassName
               + "] does not implement com.opensymphony.xwork2.interceptor.Interceptor";
      } catch (Exception e) {
         cause = e;
