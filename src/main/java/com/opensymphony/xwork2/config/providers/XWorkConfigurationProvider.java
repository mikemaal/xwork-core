...
public class XWorkConfigurationProvider implements ConfigurationProvider, Serializable {
   ...
   public void register(ContainerBuilder builder, LocatableProperties props) throws ConfigurationException {
      builder
            ...
            .factory(// silly workarounds for ognl since there is no way to flush its caches
                  PropertyAccessor.class, List.class.getName(), XWorkListPropertyAccessor.class, Scope.SINGLETON)
            ...
            .factory(ActionValidatorManager.class, "no-annotations", DefaultActionValidatorManager.class,
                  Scope.SINGLETON).factory(TextProvider.class, "system", DefaultTextProvider.class, Scope.SINGLETON)
