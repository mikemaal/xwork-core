 ...
 * @version $Revision: 1433644 $
 */
public class CompoundRootAccessor implements PropertyAccessor, MethodAccessor, ClassResolver, Serializable {
   ...
   public void setProperty(Map context, Object target, Object name, Object value) throws OgnlException {
      ...
      final String msg = "No object in the CompoundRoot has a publicly accessible property named '" + name
      ...
      for (Object o : root) {
         ...
         if ((argTypes == null) || !invalidMethods.containsKey(mc)) {
            try {
               ...
               if (!context.containsKey(OgnlValueStack.THROW_EXCEPTION_ON_FAILURE) && (mc != null) && (reason != null)
                     && (reason.getClass() == NoSuchMethodException.class)) {
