 ...
 */
public class XWorkMapPropertyAccessor extends MapPropertyAccessor implements Serializable {
   ...
   public Object getProperty(Map context, Object target, Object name) throws OgnlException {
      ...
      if (result == null) {
         ...
         Map map = (Map) target;
         result = map.get(key);
         if (result == null && Boolean.TRUE.equals(context.get(ReflectionContextState.CREATE_NULL_OBJECTS))
   ...
   private Object getValue(Map context, Object value) {
      ...
      if (elementClass == null) {
         return value;
         // nothing is specified, we assume it will be the value passed in.
      }
