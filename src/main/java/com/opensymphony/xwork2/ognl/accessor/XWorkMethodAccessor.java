 ...
 * @author tmjee
 */
public class XWorkMethodAccessor extends ObjectMethodAccessor implements Serializable {
   ...
   private Object callMethodWithDebugInfo(Map context, Object object, String methodName, Object[] objects)
   ...
   private Object callStaticMethodWithDebugInfo(Map context, Class aClass, String methodName, Object[] objects)
         throws MethodFailedException {
      try {
