 ...
 * @author Gabe
 */
public class XWorkCollectionPropertyAccessor extends SetPropertyAccessor implements Serializable {
   ...
   public Object getProperty(Map context, Object target, Object key) throws OgnlException {
      ...
      if (ReflectionContextState.isCreatingNullObjects(context)) {
         ...
         if (value == null && ReflectionContextState.isCreatingNullObjects(context)
               && objectTypeDeterminer.shouldCreateIfNew(lastBeanClass, lastPropertyClass, c, keyProperty, false)) {
 ...
 * @author Gabe
 */
class SurrugateList extends ArrayList implements Serializable {
