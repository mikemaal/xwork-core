 ...
 */
public class XWorkListPropertyAccessor extends ListPropertyAccessor implements Serializable {
   ...
   public Object getProperty(Map context, Object target, Object name) throws OgnlException {
      ...
      if (name instanceof Number && ReflectionContextState.isCreatingNullObjects(context)
