 ...
 * </pre>
 */
public class ScopedModelDrivenInterceptor extends AbstractInterceptor implements Serializable {
   ...
   protected Object resolveModel(ObjectFactory factory, ActionContext actionContext, String modelClassName,
         String modelScope, String modelName) throws Exception {
      Object model = null;
            ...
            if (cName == null) {
               try {
                  ...
                  throw new XWorkException(
                        "The " + GET_MODEL + "() is not defined in action " + action.getClass() + "", config);
               }
            }
