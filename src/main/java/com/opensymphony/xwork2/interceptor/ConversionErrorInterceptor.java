 ...
 */
public class ConversionErrorInterceptor extends AbstractInterceptor implements Serializable {
      ...
      if (fakie != null) {
         ...
         invocation.addPreResultListener(new PreResultListener() {
            ...
            public void beforeResult(ActionInvocation invocation, String resultCode) {
               Map<Object, Object> fakie = (Map<Object, Object>) invocation.getInvocationContext().get(
