 ...
 */
public class MockInterceptor implements Interceptor, Serializable {
   ...
   public boolean equals(Object o) {
      ...
      if ((expectedFoo != null) ? (!expectedFoo.equals(testInterceptor.expectedFoo))
            : (testInterceptor.expectedFoo != null)) {
         return false;
      }
