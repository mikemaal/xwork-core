...
public class ReferenceMap<K, V> implements Map<K, V>, Serializable {
   ...
   Set<K> dereferenceKeySet(Set keyReferences) {
      return keyReferenceType == STRONG ? keyReferences : dereferenceCollection(keyReferenceType, keyReferences,
            new HashSet());
   }
   ...
   Collection<V> dereferenceValues(Collection valueReferences) {
      return valueReferenceType == STRONG ? valueReferences : dereferenceCollection(valueReferenceType,
            valueReferences, new ArrayList(valueReferences.size()));
   }
    ...
    */
   static class ReferenceAwareWrapper implements Serializable {
    ...
    */
   static class KeyReferenceAwareWrapper extends ReferenceAwareWrapper implements Serializable {
   ...
   class SoftKeyReference extends FinalizableSoftReference<Object> implements InternalReference, Serializable {
   ...
   class WeakKeyReference extends FinalizableWeakReference<Object> implements InternalReference, Serializable {
   ...
   class SoftValueReference extends FinalizableSoftReference<Object> implements InternalReference, Serializable {
   ...
   class WeakValueReference extends FinalizableWeakReference<Object> implements InternalReference, Serializable {
   ...
   class Entry implements Map.Entry<K, V>, Serializable {
