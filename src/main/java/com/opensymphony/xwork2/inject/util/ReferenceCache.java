 ...
 */
public abstract class ReferenceCache<K, V> extends ReferenceMap<K, V> implements Serializable {
    ...
    */
   public static <K, V> ReferenceCache<K, V> of(ReferenceType keyReferenceType, ReferenceType valueReferenceType,
