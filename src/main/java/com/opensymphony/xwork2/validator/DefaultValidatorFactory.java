 ...
 *
 * @version $Date: 2013-04-18 08:19:52 +0200 (Thu, 18 Apr 2013) $ $Id: DefaultValidatorFactory.java 1469181 2013-04-18 06:19:52Z lukaszlenart $
...
public class DefaultValidatorFactory implements ValidatorFactory, Serializable {
   ...
   public Validator getValidator(ValidatorConfig cfg) {
      ...
      try {
         ...
         validator = objectFactory.buildValidator(className, cfg.getParams(), ActionContext.getContext()
               .getContextMap());
      } catch (Exception e) {
         final String msg = "There was a problem creating a Validator of type " + className + " : caused by "
               + e.getMessage();
